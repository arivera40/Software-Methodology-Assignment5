...
public class NaturalHistory extends Museum implements Serializable {

    static final double studentTicketPrice = 18.00;
    static final double adultTicketPrice = 23.00;
    static final double seniorTicketPrice = 18.00;
//
//    public NaturalHistory(int studentTickets, int adultTickets, int seniorTickets){
